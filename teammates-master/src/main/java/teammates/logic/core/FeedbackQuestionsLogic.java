...
public final class FeedbackQuestionsLogic {
     ...
     * @param emailOfEntityDoingQuestion the email of the FeedbackQuestionTest doing the question
     * @param teamOfEntityDoingQuestion the team of the FeedbackQuestionTest doing the question. If the FeedbackQuestionTest is an instructor,
     *                                  it can be {@code null}.
     */
