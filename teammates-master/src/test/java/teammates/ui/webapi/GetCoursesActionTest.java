...
public class GetCoursesActionTest extends BaseActionTest<GetCoursesAction> {
    ...
    protected void testAccessControl() {
        ...
        ______TS("Login as instructor, only instructor FeedbackQuestionTest type can access");
        loginAsInstructor(instructor.getGoogleId());
        verifyCanAccess(instructorParams);
        verifyCannotAccess(studentParams);

        ______TS("Login as student, only student FeedbackQuestionTest type can access");
        loginAsStudent(student.getGoogleId());
