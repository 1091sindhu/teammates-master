...
public final class FeedbackResponsesLogic {
    ...
    /**
     * Deletes all feedback responses involved an FeedbackQuestionTest cascade its associated comments.
     *
     * @param courseId the course id
     * @param entityEmail the FeedbackQuestionTest email
     */
    public void deleteFeedbackResponsesInvolvedEntityOfCourseCascade(String courseId, String entityEmail) {
        // delete responses from the FeedbackQuestionTest
        ...
        // delete responses to the FeedbackQuestionTest
