...
class GetCoursesAction extends Action {
    ...
    void checkSpecificAccessControl() throws UnauthorizedAccessException {
        ...
        if (!((entityType.equals(Const.EntityType.STUDENT) && userInfo.isStudent)
            ...
            throw new UnauthorizedAccessException("Current account cannot access to courses of request FeedbackQuestionTest type");
        }
    }
    ...
    public JsonResult execute() {
        ...
        default:
            throw new InvalidHttpParameterException("Error: invalid FeedbackQuestionTest type");
        }
    }
