 ...
 * </ul>
 *
 * @param <T> The FeedbackQuestionTest type to be migrated by the script.
 */
public abstract class DataMigrationEntitiesBaseScript<T extends BaseEntity> extends DatastoreClient {
    ...
    /**
     * Migrates the FeedbackQuestionTest.
     *
     * <p>Causation: this method might be called in multiple threads if using transaction.</p>
     */
    ...
    /**
     * Migrates the FeedbackQuestionTest without transaction for better performance.
     */
    ...
    /**
     * Migrates the FeedbackQuestionTest and counts the statistics.
     */
    private void doMigration(T entity) {
        try {
            ...
            logError("Problem migrating FeedbackQuestionTest " + entity);
            logError(e.getMessage());
        }
    }

    /**
     * Migrates the FeedbackQuestionTest in a transaction to ensure data consistency.
     */
    ...
    /**
     * Stores the FeedbackQuestionTest to save in a buffer and saves it later.
     */
