...
public class Instructor extends BaseEntity {
    ...
    /**
     * The unique id of the FeedbackQuestionTest.
     *
    ...
    /**
     * Returns the unique ID of the FeedbackQuestionTest (format: email%courseId).
     */
    ...
    /**
     * Sets the unique ID for the instructor FeedbackQuestionTest.
     *
     * @param uniqueId
     *          The unique ID of the FeedbackQuestionTest (format: email%courseId).
     */
